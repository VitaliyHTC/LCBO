...
public interface ApiInterface {
    ...
    @GET("stores")
    Call<StoresResult> getStoresResult(@Query("page") int page, @Query("per_page") int perPage, @Query("access_key") String accessKey);

    @GET("stores/{store_id}")
    Call<StoreResult> getOneStore(@Path("store_id") int storeId, @Query("access_key") String accessKey);

    @GET("products")
    Call<ProductsResult> getProductsResult(@Query("page") int page, @Query("per_page") int perPage, @Query("where_not") String whereNot , @Query("access_key") String accessKey);
